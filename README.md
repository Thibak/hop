...
Далее:
    Управляющая система:
        сохранение созданного эксперимента, бинд к цсв
            ...
            досчет, прогресс
Далее:
    Хорошо бы сделать подсказку о порядке действий изнутри, и систему проверки целостности модулей.
--------------------------------
...
XML:
    основным рабочим элементом является фабрика. Вопрос, где его создовать. При сохранении и 

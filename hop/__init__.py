...
# 2. генератор технических событий RoutineEvents (принимающий теже параметры), пока содержащий всего один полезный метод -- стоп-машина. Без такого события расчет длится бесконечно. Если клетки не элиминируют естественно. Удобен простотой вызова
